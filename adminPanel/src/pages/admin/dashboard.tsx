    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <StatsCard
          ...
          iconBg="bg-amber-100"
          icon={<svg className="w-6 h-6 text-amber-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4.336 5.336l.707.707M3 12H2m1.636-6.636l.707.707M7 21h6m-9 0h-3m12 0h3m-9 0l-2 2m6-2l2 2" /></svg>}
        />
        <StatsCard
          title="今日生成次数"
